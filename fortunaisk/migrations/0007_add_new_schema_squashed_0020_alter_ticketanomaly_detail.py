...
def forwards_func(apps, schema_editor):
    ...
    for auto in AutoLottery.objects.all():
        ...
        try:
            ...
            auto.winners_distribution = [float(d.strip('%')) for d in distributions if d.strip()]
            auto.save()
        except Exception as e:
    ...
    for webhook in WebhookConfiguration.objects.all():
        ...
        if isinstance(roles, str):
            try:
                ...
                webhook.ping_roles = [role.strip() for role in roles.split(',') if role.strip()]
                webhook.save()
            except Exception as e:
...
class Migration(migrations.Migration):
    ...
    replaces = [('fortunaisk', '0007_add_new_schema'), ('fortunaisk', '0008_migrate_data'), ('fortunaisk', '0009_fill_processedpayment_fields'), ('fortunaisk', '0010_autolottery_tax_lottery_tax'), ('fortunaisk', '0011_autolottery_tax_amount_lottery_tax_amount'), ('fortunaisk', '0012_alter_autolottery_winners_distribution_and_more'), ('fortunaisk', '0013_remove_lottery_winners_distribution'), ('fortunaisk', '0014_alter_webhookconfiguration_options_and_more'), ('fortunaisk', '0015_alter_webhookconfiguration_options_and_more'), ('fortunaisk', '0016_convert_notification_config'), ('fortunaisk', '0017_fill_webhook_names'), ('fortunaisk', '0018_fill_detail_empty'), ('fortunaisk', '0019_fix_ping_roles'), ('fortunaisk', '0020_alter_ticketanomaly_detail')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lottery_reference', models.CharField(db_index=True, max_length=20, verbose_name='Lottery Reference')),
                ('winner_rank', models.PositiveIntegerField(verbose_name='Winner Rank')),
                ('winner_prize_distribution', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='Prize Distribution (%)')),
        ...
        migrations.AddField(
            model_name='processedpayment',
            name='amount',
            field=models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Total amount paid in ISK.', max_digits=25, verbose_name='Total Paid Amount'),
        ),
        migrations.AddField(
            model_name='processedpayment',
            name='payed_at',
            field=models.DateTimeField(blank=True, help_text='Payment date & time.', null=True, verbose_name='Paid At'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='ticketanomaly',
            name='detail',
            field=models.TextField(blank=True, help_text='Resolution details.', null=True, verbose_name='Resolution Detail'),
        ),
        migrations.AddField(
            model_name='winner',
            name='distributed_at',
        ...
        migrations.AddField(
            ...
            field=models.JSONField(blank=True, default=dict, help_text='Notification settings (channels, types, etc).', verbose_name='Notification Config'),
        ),
        migrations.AddField(
            model_name='webhookconfiguration',
            name='created_at',
        ...
        migrations.AlterModelOptions(
            ...
            options={'default_permissions': (), 'verbose_name': 'Webhook Configuration'},
        ),
        migrations.AlterField(
            model_name='lottery',
        ...
        migrations.AlterField(
            model_name='webhookconfiguration',
            name='created_by',
            field=models.ForeignKey(blank=True, help_text='User who created this configuration.', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='webhook_configurations', to=settings.AUTH_USER_MODEL, verbose_name='Created By'),
        ),
        migrations.AlterField(
            model_name='webhookconfiguration',
            name='notification_config',
            field=models.JSONField(blank=True, default=dict, help_text='JSON object with two keys:\n  • "events": list of event names to send publicly\n  • "ping_roles": list of Discord role IDs to mention on each notification\nExample:\n{\n  "events": [\n    "lottery_created",\n    "lottery_sales_closed",\n    "anomaly_detected"\n  ],\n  "ping_roles": ["123456789012345678", "987654321098765432"]\n}', verbose_name='Notification Configuration'),
        ),
        migrations.AlterField(
            model_name='webhookconfiguration',
            name='webhook_url',
            field=models.URLField(blank=True, help_text='URL of the Discord webhook to send public notifications. Leave blank to disable.', null=True, verbose_name='Discord Webhook URL'),
        ),
        migrations.AlterModelOptions(
            name='webhookconfiguration',
