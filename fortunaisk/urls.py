...
urlpatterns = [
    ...
    path("lottery_create/", views.create_lottery, name="lottery_create"),
    path("auto_lotteries/", views.list_auto_lotteries, name="auto_lottery_list"),
    path(
        "auto_lotteries/create/", views.create_auto_lottery, name="auto_lottery_create"
    ),
    path(
        "auto_lotteries/edit/<int:autolottery_id>/",
        views.edit_auto_lottery,
